...
learn_func_list = [
    ...
    lambda e: ACER(policy=MlpPolicy, env=e, replay_start=100, lr_schedule='constant', gamma=0.5, delta=10, rprop_alpha=0.999,
                   ent_coef=0.0, learning_rate=1e-3, replay_ratio=10).learn(total_timesteps=80000, seed=0),
