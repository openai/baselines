...
from baselines.common.policies import ActorCriticPolicy
...
class DeepQ(BaseRLModel):
    def __init__(self, policy, env, gamma=0.99, learning_rate=5e-4, buffer_size=50000, exploration_fraction=0.1,
        ...
        assert not isinstance(policy, ActorCriticPolicy), \
            "Error: DeepQ does not support the actor critic policies, please use the 'baselines.deepq.models.mlp' and" \
            " 'baselines.deepq.models.cnn_to_mlp' functions to create your policies."
