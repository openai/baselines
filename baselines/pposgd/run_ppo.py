...
def train(env_id, num_timesteps, seed, num_cpu, resume, agentName, logdir,portnum):
    ...
    pposgd_simple.learn(env, policy_fn, 
            ...
            optim_epochs=20, optim_stepsize=3e-4, optim_batchsize=128,
...
def main():
    ...
    train(args['env_id'], num_timesteps=1e6, seed=args['seed'], num_cpu=args['num_cpu'], resume=args['resume'], agentName=args['agentName'], logdir=args['logdir'], portnum=utils.portnum)
