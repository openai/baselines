...
<<<<<<< HEAD:stable_baselines/ppo1/pposgd_simple.py
...
from stable_baselines.gail.trpo_mpi import traj_segment_generator, add_vtarg_and_adv, flatten_lists
...
def learn(env, policy_fn, *, timesteps_per_actorbatch, clip_param, entcoeff, optim_epochs, optim_stepsize,
    ...
    return policy
=======
from baselines.common import Dataset, explained_variance, fmt_row, zipsame, BaseRLModel, SetVerbosity
...
class PPO1(BaseRLModel):
    ...
    def load(cls, load_path, env=None, **kwargs):
        ...
        return model
>>>>>>> refactoring:baselines/ppo1/pposgd_simple.py
